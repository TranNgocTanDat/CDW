...
public class ProductService {
    ...
    public Product createProduct(ProductRequest request) {
        ...
        if (optionalProduct.isPresent()) {
            ...
            // Có thể cập nhật thêm mô tả, giá,... nếu bạn muốn:
            productMapper.updateProduct(existingProduct, request);

            return productRepository.save(existingProduct);
        }

        // Nếu là sản phẩm mới thì phải gán Category trước khi lưu
        Category category = categoryRepository.findById(String.valueOf(request.getCate_ID()))
